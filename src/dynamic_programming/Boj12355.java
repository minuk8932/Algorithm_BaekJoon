 ...
 * 
 * 	@author minchoba
 *	백준 12355번: Oncean View (Large)
 *
 *	@see https://www.acmicpc.net/problem/12355/
 *
 */
public class Boj12355 {
	...
	private static int lis(int n, int[] arr) {
		...
		for(int i = 1; i < n; i++) {				// 가장 긴 증가하는 부분 수열 = 남은 집
			if(arr[i] == dp[index]) continue;
