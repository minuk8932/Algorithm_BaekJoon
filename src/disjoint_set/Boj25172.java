 ...
 * 백준 25172번: 꼼꼼한 쿠기의 졸업여행
 *
 * @see https://www.acmicpc.net/problem/25172
 *
 */
public class Boj25172 {

    private static final String C = "CONNECT\n";
    private static final String D = "DISCONNECT\n";

    private static ArrayList<ArrayList<Integer>> connections = new ArrayList<>();
     ...
     * Traveling
     *
     * line 71 ~ 84: offline query process, revoke sequence
     *
     * @param query
     * @return
     */
    private static String travel(ArrayDeque<Integer> query) {
        ...
        while(!query.isEmpty()) {
            ...
            for(int adj: connections.get(current)) {
                if(!visit[adj]) continue;
                merge(current, adj);
            }

            stack.push(count == -parent[find(current)] ? C: D);
        }
